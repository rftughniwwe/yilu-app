	...
	<view class="container">
		<view class="page-body">
			<view class='wrapper'>
				...
				<editor id="editor" class="ql-container" @blur="inputblur"  placeholder="开始输入..." showImgSize showImgToolbar showImgResize
				 @statuschange="onStatusChange" @input="cententChange" :read-only="readOnly" @ready="onEditorReady">
				</editor>
			</view>
		</view>
